...
//     const pageWidth = doc.internal.pageSize.getWidth();
//     const textWidth = doc.getTextWidth(title);
//     doc.text(title, (pageWidth - textWidth) / 2, 240);
...
//         ['Resident Name:', formData.name],
//         ['Room No:', formData.roomNumber],
//         ['Vacating Date:', formData.vacatingDate],
//         ['Deposit Cleared:', formData.depositCleared],
//         formData.depositCleared === 'No' ? ['Remaining Deposit:', formData.remainingDeposit] : null,
//         ['Approval Date:', formData.approvalDate],
//         ['Damage:', formData.damage],
//         formData.damage === 'Yes' ? ['Damage Details:', formData.damageDetails] : null,
//         ['Parent Approval:', formData.parentApproval],
//       ].filter(Boolean);
//     }
...
//       body: tableData,
//       startY: 250,
//       styles: { fontSize: 24, textColor: 0 },
//       theme: 'plain',
//       columnStyles: { 0: { fontStyle: 'bold', cellWidth: 250 }, 1: { cellWidth: 'auto' } },
//     });
...
//     <div className="container">
//       <div className="form">
//         <h2 className="heading">Generate PDF Receipt</h2>
//         <form onSubmit={(e) => { e.preventDefault(); generatePDF(); }}>
//           <label className="label">Receipt Type:
//             <select name="receiptType" value={formData.receiptType} onChange={handleChange} className="input">
//               <option value="Rent">Rent</option>
//               <option value="Deposit">Deposit</option>
...
//           <label className="label">Name: <input type="text" name="name" value={formData.name} onChange={handleChange} className="input" required /></label>
//           <label className="label">Room Number: <input type="number" name="roomNumber" value={formData.roomNumber} onChange={handleChange} className="input" required /></label>

//           {formData.receiptType === 'Vacating' && (
//             <>
//               <label className="label">Vacating Date: <input type="date" name="vacatingDate" value={formData.vacatingDate} onChange={handleChange} className="input" required /></label>
//               <label className="label">Deposit Cleared:
//                 <select name="depositCleared" value={formData.depositCleared} onChange={handleChange} className="input">
//                   <option value="Yes">Yes</option>
//                   <option value="No">No</option>
//                 </select>
//               </label>
//               {formData.depositCleared === 'No' && <label className="label">Remaining Deposit: <input type="number" name="remainingDeposit" value={formData.remainingDeposit} onChange={handleChange} className="input" /></label>}
//               <label className="label">Damage:
//                 <select name="damage" value={formData.damage} onChange={handleChange} className="input">
//                   <option value="No">No</option>
//                   <option value="Yes">Yes</option>
//                 </select>
//               </label>
//               {formData.damage === 'Yes' && <label className="label">Damage Details: <input type="text" name="damageDetails" value={formData.damageDetails} onChange={handleChange} className="input" /></label>}
//             </>
//           )}
//           <button type="submit" className="button">Generate PDF</button>
//         </form>
